...
import { DeviceConfigsLambdaClientV1 } from '../../src/version1/DeviceConfigsLambdaClientV1';

suite('DeviceConfigsLambdaClient', ()=> {
    ...
    let client: DeviceConfigsLambdaClientV1;
    let fixture: DeviceConfigsClientFixtureV1;

    setup((done) => {
        client = new DeviceConfigsLambdaClientV1();
